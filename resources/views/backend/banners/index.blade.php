                    ...
                    <div class="navbar-collapse collapse" id="navbar-filter">
                        <form action="" method="GET">
                            ...
                            <div class="navbar-right hidden-xs">
                                ...
                                <a href="{{ route('admin.banners.index') }}" class="btn color-black">
                                    <i class="icon-cancel-circle2 position-left"></i>
                                </a>

                                <a href="{{ route('admin.banners.create') }}" class="btn text-primary">
                                    <i class="icon-plus3 position-left"></i>
                                </a>
                            </div>
                        </form>
                                        ...
                                        <ul class="icons-list">
                                            ...
                                            <li>
                                                <form action="{{ route('admin.banners.delete', $banner->id) }}"
                                                      ...
                                                      onsubmit="return confirm('Bạn có chắc chắn muốn xoá {{ $banner->name }}?');">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit"
