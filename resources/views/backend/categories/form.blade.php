    ...
    <form id="productForm"
        ...
        <div class="col-md-12">
            <div class="col-md-9">
                    ...
                    <div class="panel-body">
                        <fieldset class="content-group">
                            ...
                            <div class="form-group has-feedback @if($errors->first('content')) has-error @endif">
                                ...
                                <textarea class="ck-editor"
                                          id="content"
                                          name="content">{{ old('content', $category->content ?? '') }}</textarea>
                                <div class="form-control-feedback">
                ...
                @include('backend.components.seo', ['model' => $category ?? null])
            </div>
            <div class="col-md-3">
                <div class="panel panel-flat">
                    <div class="panel-body">
                ...
                <div class="panel panel-flat">
                    <div class="panel-body">
                        <fieldset class="content-group">
                            ...
                            @include('backend.components.image', ['model' => $category ?? null])
                        </fieldset>
                    </div>
                </div>
                <div class="panel panel-flat">
