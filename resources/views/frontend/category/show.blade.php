    ...
    <div id="mainContent" class="z-20 mx-auto bg-neutral-100">
        <div class="bg-white pt-11 md:pb-0 md:pt-4">
            ...
            <div id="category-page"
                 ...
                 data-filter-url="{{ route('ajax.category.filter', ['id' => $category->id]) }}"
                 data-load-more-url="{{ route('ajax.category.loadMore', ['id' => $category->id]) }}"
                                                ...
                                                <div class="space-y-2">
                                                    <div class="grid gap-3 md:gap-4">
                                                        <div class="flex items-start justify-between">
                                                            <p class="text-base font-semibold md:text-sm">Thương
                                                                hiệu</p>
                                                        </div>
