    ...
    >
        <a href="/"
           class="relative grid h-full grid-rows-2 justify-center border-0 px-1 py-2 text-center text-sm font-medium
               ...
               focus:ring-primary-300 data-[size=sm]:text-sm {{request()->routeIs('homepage.index') ? '!text-primary-500' : ''}}"
        >
        <span>
            <span
        ...
        <a href="{{route('category.index')}}"
           class="relative grid h-full grid-rows-2 justify-center border-0 px-1 py-2 text-center text-sm font-medium
               bg-transparent text-neutral-600 outline-none hover:bg-0 hover:text-neutral-600 focus:text-neutral-600
               focus:ring-primary-300 data-[size=sm]:text-sm {{request()->routeIs('category.index') ? '!text-primary-500' : ''}}"
        >
        <span>
            <span
                    class="p-icon inline-flex h-6 w-6 max-h-full max-w-full items-center justify-center align-[-0.125em]"
        ...
        >
        <span
                class="mx-auto mt-[-30px] h-14 w-14 rounded-full bg-primary-500 p-3 text-xl text-white"
        >
            <span
        ...
        <a
                ...
                class="relative grid h-full grid-rows-2 justify-center border-0 px-1 py-2 text-center text-sm font-medium
               bg-transparent text-neutral-600 outline-none hover:bg-0 hover:text-neutral-600 focus:text-neutral-600
               focus:ring-primary-300 data-[size=sm]:text-sm {{request()->routeIs('account.contact-history') ? '!text-primary-500' :''}}"
        >
        <span>
            <span
                    class="p-icon inline-flex h-6 w-6 max-h-full max-w-full items-center justify-center align-[-0.125em]"
        ...
        <a
            ...
            class="relative grid h-full grid-rows-2 justify-center border-0 px-1 py-2 text-center text-sm font-medium
               bg-transparent text-neutral-600 outline-none hover:bg-0 hover:text-neutral-600 focus:text-neutral-600
               focus:ring-primary-300 data-[size=sm]:text-sm {{request()->routeIs('account.index') ? '!text-primary-500' :''}}"
        >
        <span>
            <span
                class="p-icon inline-flex h-6 w-6 max-h-full max-w-full items-center justify-center align-[-0.125em]"
