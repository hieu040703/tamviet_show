    ...
    <div class="absolute bottom-0 h-full w-full md:bg-[var(--background)] md:static">
        <picture>
            ...
            <img
                ...
                data-rank="default" decoding="async"></picture>
        <div class="hidden h-8 bg-primary-50 md:flex">
            ...
            >
                ...
                <div class="grid grid-flow-col gap-4 text-xs"><span
                    ...
                    <a rel="noopener noreferrer" target="_blank"
                       class="grid grid-flow-col items-center justify-start gap-1" href="/cam-nang-mua-sam">
                        <p title="Deal hot tháng 11 🔥" class="truncate">Deal hot tháng 11 🔥</p>
                    </a>
                    <a target="_self" class="grid grid-flow-col items-center justify-start gap-1"
                       href="/tra-cuu-don-hang">
                        <p title="Tra cứu đơn hàng" class="truncate">Tra cứu đơn hàng</p>
                        <div class="relative h-4 w-8"><img class="object-cover"
                                                           src="https://prod-cdn.pharmacity.io/e-com/images/ecommerce/20240816073820-0-Frame%2024020.png"
                    ...
                    <a target="_self" class="grid grid-flow-col items-center justify-start gap-1"
                       href="/he-thong-cua-hang">
                        <p title="Hệ thống nhà thuốc" class="truncate">Hệ thống nhà thuốc</p>
                    </a>
                </div>
            </div>
        </div>
        <div class="mx-auto w-full md:container md:relative md:pb-3 md:pt-4">
            <div class="flex items-center md:mb-4">
                <div class="flex w-full flex-col-reverse items-start md:flex-row">
                    ...
                    <div class="z-[11] grid w-full grid-cols-1 md:z-[10]">
                        ...
                        >
                            ...
                            <div class="w-full drop-shadow">
                                ...
                                <div
                                    class="mt-[3px] line-clamp-1 hidden h-5 flex-wrap space-x-3 text-xs text-white md:flex"
                                >
                                    <div class="h-5"><a
                                            href="https://www.pharmacity.vn/collection/khau-trang?utm_source=web&amp;utm_medium=search&amp;utm_campaign=khautrang"><span
                                                title="khẩu trang"
                                                class="text-[14px] leading-[20px]">khẩu trang</span></a></div>
                                    <div class="h-5"><a
                                            href="/search?keyword=s%E1%BB%AFa%20dinh%20d%C6%B0%E1%BB%A1ng&amp;order=desc&amp;order_by=de-xuat"><span
                                                title="sữa dinh dưỡng"
                                                class="text-[14px] leading-[20px]">sữa dinh dưỡng</span></a>
                                    </div>
                                    <div class="h-5"><a
                                            href="/search?keyword=probiotics&amp;order=desc&amp;order_by=de-xuat"><span
                                                title="probiotics"
                                                class="text-[14px] leading-[20px]">probiotics</span></a></div>
                                    <div class="h-5"><a
                                            href="https://www.pharmacity.vn/san-pham-chong-nang?page=1&amp;utm_source=web&amp;utm_medium=keyword&amp;utm_campaign=kcn"><span
                                                title="kem chống nắng"
                                                class="text-[14px] leading-[20px]">kem chống nắng</span></a>
                                    </div>
                                    <div class="h-5"><a
                                            href="https://www.pharmacity.vn/collection/collagen---bi-quyet-dep-tu-ben-trong?utm_source=web&amp;utm_medium=keyword&amp;utm_campaign=2025&amp;utm_content=de_collagen"><span
                                                title="collagen"
                                                class="text-[14px] leading-[20px]">collagen</span></a></div>
                                    <div class="h-5"><a
                                            href="https://www.pharmacity.vn/tpcn-nhom-tieu-hoa?utm_source=web&amp;utm_medium=keyword&amp;utm_campaign=tieuhoa"><span
                                                title="tiêu hóa"
                                                class="text-[14px] leading-[20px]">tiêu hóa</span></a></div>
                                    <div class="h-5"><a
                                            href="https://www.pharmacity.vn/collection/ha-sot-giai-cam?utm_source=web&amp;utm_medium=keyword&amp;utm_campaign=hasot"><span
                                                title="hạ sốt" class="text-[14px] leading-[20px]">hạ sốt</span></a>
                                    </div>
                                    <div class="h-5"><a
                                            href="https://www.pharmacity.vn/collection/uu-dai-to-mua-1-tang-1?utm_source=web&amp;utm_medium=keyword&amp;utm_campaign=mua1tang1"><span
                                                title="Mua 1 Tặng 1"
                                                class="text-[14px] leading-[20px]">Mua 1 Tặng 1</span></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div id="fixedNav"
                         class="top-0 z-10 flex w-full min-w-[340px] flex-1 flex-row-reverse gap-3 px-4 py-3 text-right transition-colors max-md:bg-primary-500 md:static md:mx-0 md:min-w-[286px] md:flex-row md:pb-0 md:pl-1.5 md:pr-0 md:pt-0"
                    >
                        <div class="grid w-[88px] grid-cols-2 justify-items-end gap-2">
                            <div
                            ...
                            <div class="hidden md:ml-2 md:inline-flex">
                                <button data-size="sm" type="button"
                                        class="relative justify-center outline-none font-semibold bg-white border border-neutral-200 hover:bg-bg-white hover:text-primary-500 focus:text-primary-500 text-sm px-4 py-2 h-9 items-center rounded-full btn-login flex">
                                            <span
                                                class="p-icon inline-flex align-[-0.125em] justify-center max-h-full max-w-full m-[-1] mr-1 h-6 w-6 px-0"><svg
                                                    viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path
                                                        ...
                                                        fill="currentColor"></path></svg></span> <span>Đăng nhập/ Đăng ký</span>
                                </button>
                            </div>
                    ...
                    <div class="swiper category-playlist w-full swiper-backface-hidden">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide !w-fit md:mr-3 lg:mr-5">
                                <a class="flex items-center" href="/duoc-pham">
                                    <span class="text-base font-medium">Thuốc</span>
                                </a>
                            </div>
                            <div class="swiper-slide !w-fit md:mr-3 lg:mr-5">
                                <a class="flex items-center" href="/benh">
                                    <span class="text-base font-medium">Tra cứu bệnh</span>
                                </a>
                            </div>
                            <div class="swiper-slide !w-fit md:mr-3 lg:mr-5">
                                <a class="flex items-center" href="/thuc-pham-chuc-nang">
                                    <span class="text-base font-medium">Thực phẩm bảo vệ sức khỏe</span>
                                </a>
                            </div>
                            <div class="swiper-slide !w-fit md:mr-3 lg:mr-5">
                                <a class="flex items-center" href="/me-va-be">
                                    <span class="text-base font-medium">Mẹ và bé</span>
                                </a>
                            </div>
                            <div class="swiper-slide !w-fit md:mr-3 lg:mr-5">
                                <a class="flex items-center" href="/shop/pharmacity">
                                    <span class="text-base font-medium">Nhãn hàng Pharmacity</span>
                                    <img class="ml-1 h-4 w-8"
                                         src="https://prod-cdn.pharmacity.io/e-com/images/ecommerce/20240328094819-0-Frame%2024020%20%282%29.png"
                                         alt="Nhãn hàng Pharmacity" loading="lazy">
                                </a>
                            </div>
                            <div class="swiper-slide !w-fit md:mr-3 lg:mr-5">
                                <a class="flex items-center" href="/cham-soc-ca-nhan">
                                    <span class="text-base font-medium">Chăm sóc cá nhân</span>
                                </a>
                            </div>
                            <div class="swiper-slide !w-fit md:mr-3 lg:mr-5">
                                <a class="flex items-center" href="/cham-soc-sac-dep">
                                    <span class="text-base font-medium">Chăm sóc sắc đẹp</span>
                                </a>
                            </div>
                            <div class="swiper-slide !w-fit md:mr-3 lg:mr-5">
                                <a class="flex items-center" href="/thiet-bi-y-te-2">
                                    <span class="text-base font-medium">Thiết bị y tế</span>
                                </a>
                            </div>
                        </div>
