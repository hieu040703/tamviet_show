<div class="md:container md:mb-4 home-hero">
    <div class="gid gap-4 md:flex md:aspect-[1200/302]">
            ...
            <div class="relative flex h-full w-full items-center">
                <div
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <?php if(!empty($homeMainBanner)): ?>
                            <?php $__currentLoopData = $homeMainBanner->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $MainBannerItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="swiper-slide relative h-full w-full">
                                    <picture>
                                        <source media="(max-width:767px)"
                                                srcset="<?php echo e(asset($MainBannerItem->image) ? asset('storage/' .$MainBannerItem->image)  : asset('frontend/assets/image/banner/banner-1.png')); ?>">
                                        <img class="h-full w-full md:rounded-xl md:object-[unset]"
                                             src="<?php echo e(asset($MainBannerItem->image) ? asset('storage/' .$MainBannerItem->image)  : asset('frontend/assets/image/banner/banner-1.png')); ?>"
                                             alt="<?php echo e($MainBannerItem->name ?? ''); ?>"
                                             loading="eager">
                                    </picture>
                                </div>
                        ...
                        <?php else: ?>
                            <div class="swiper-slide relative h-full w-full">
                                <picture>
                                    <source media="(max-width:767px)"
                                            srcset="<?php echo e(asset('frontend/assets/image/banner/banner-1.png')); ?>">
                                    <img class="h-full w-full md:rounded-xl md:object-[unset]"
                                         src="<?php echo e(asset('frontend/assets/image/banner\banner-1.png')); ?>"
                                         loading="eager">
                                </picture>
                            </div>
                        <?php endif; ?>
        ...
        <div class="hidden w-full grid-rows-2 gap-4 md:grid md:w-[389px]">
            <?php if(!empty($homeRightBanner) && $homeRightBanner->items->count()): ?>
                <?php $__currentLoopData = $homeRightBanner->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rightBannerItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="h-full w-full">
                        <img
                            class="h-full w-full object-[unset] md:rounded-xl"
                            src="<?php echo e(!empty($rightBannerItem->image)
                            ? asset('storage/'.$rightBannerItem->image)
                            : asset('frontend/assets/image/banner/right/banner-1.png')); ?>"
                            alt="<?php echo e($rightBannerItem->name ?? ''); ?>"
                            loading="lazy"
                            width="500"
                            height="500"
                        >
            ...
            <?php else: ?>
                ...
                <div class="h-full w-full">
                    <img
                        class="h-full w-full object-[unset] md:rounded-xl"
                        src="<?php echo e(asset('frontend/assets/image/banner/banner-2.png')); ?>"
