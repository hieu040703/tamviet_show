<?php
    ...
    $block_1  = $homeProductCategories1 ?? [];
            ...
            <div class="block-title flex items-center space-x-1 p-4 md:px-0">
                <div class="flex flex-1">
                    <h4 class="p-icon-1 font-semibold line-clamp-1 text-base md:text-[20px]">
                        <?php echo e($widget->name ?? 'Danh mục sản phẩm'); ?>
                        ...
                        >
                            <div class="swiper-wrapper">
                                <?php $__currentLoopData = $items_1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item_1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php
                                        $image_1 = $item_1->image
                                            ? asset('storage/'.$item_1->image)
                                            : asset('backend/img/not-found.jpg');
                                    ?>
                                        ...
                                        <div class="mr-[10px] md:mr-4 h-full relative !max-h-[460px]">
                                            <div class="product-card flex h-full flex-col">
                                                <div
                                                    class="flex h-full flex-1 flex-col overflow-hidden rounded-lg border bg-white pb-[1px] shadow-sm">
                                                    <div class="product-card-image relative">
                                                        <a href="<?php echo e(router_link('products', $item_1->id)); ?>">
                                                            <img
                                                                class="max-h-[100%] max-w-[100%] object-contain"
                                                                src="<?php echo e($image_1); ?>"
                                                                alt="<?php echo e($item_1->name); ?>"
                                                                width="500"
                                                                height="500"
                                                                loading="lazy"
                                                                decoding="async"
                                                        ...
                                                        <div class="flex flex-1 flex-col justify-end">
                                                            <div class="flex items-end justify-center">
                                                                <button
                                                                    type="button"
                                                                    data-open-product-modal
                                                                    data-product-id="<?php echo e($item_1->id); ?>"
                                                                    data-product-name="<?php echo e($item_1->name); ?>"
                                                                    data-product-image="<?php echo e($image_1); ?>"
                                                                    class="btn-choose-product relative z-10 flex justify-center items-center
                                                                   w-full h-9 mt-2 px-4 py-2 text-sm font-semibold text-white
                                                                   bg-primary-500 border-0 rounded-lg outline-none
                                                                   hover:bg-primary-600 focus:ring-primary-300">
...
<?php /**PATH C:\laragon\www\tamviet-ecommerce\resources\views/frontend/components/deal.blade.php ENDPATH**/ ?>