...
<div class="w-[62px] grid-cols-2 justify-items-end gap-2">
    <a href="<?php echo e(route('cart.index')); ?>"
       class="relative flex h-9 w-9 items-center justify-center rounded-full border-0 bg-white p-2 md:!h-10 md:!w-10 md:bg-transparent md:text-white hover:md:bg-transparent hover:md:text-white focus:md:text-white">
        ...
        <div
            data-cart-count
            class="absolute -right-0.5 top-0 inline-flex h-[18px] min-w-[18px] items-center justify-center rounded-full border border-white bg-orange-500 px-1 text-xs font-bold text-white dark:border-neutral-900 md:right-0 md:h-5 md:min-w-[20px] <?php echo e($cartCount ? '' : 'hidden'); ?>">
            <?php echo e($cartCount); ?>

        </div>
    </a>
</div>
<?php /**PATH C:\laragon\www\tamviet-ecommerce\resources\views/frontend/components/cart-icon-desktop.blade.php ENDPATH**/ ?>