        ...
        <div class="hidden md:inline-flex relative" data-account-wrapper>
            ...
            >
                <img
                    ...
                    height="500"
                >
                <div class="ml-1 line-clamp-1 flex-1 text-left font-bold">Chào, <?php echo e($displayName); ?></div>
                ...
                <ul class="list-none">
                    <li class="cursor-pointer">
                        <a
                            ...
                            href="<?php echo e(route('account.personal-info')); ?>"
                        >
...
<?php /**PATH C:\laragon\www\tamviet-ecommerce\resources\views/frontend/components/header/account-area.blade.php ENDPATH**/ ?>