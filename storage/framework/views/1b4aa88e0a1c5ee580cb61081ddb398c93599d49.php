<div class="panel panel-flat">
    <div class="panel-body">
        <fieldset class="content-group">
            ...
            <div id="album-list-wrapper" class="<?php echo e(count($gallery) ? '' : 'hidden'); ?>">
                    ...
                    <?php $__currentLoopData = $gallery; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-md-3 col-sm-4 col-xs-6 album-item">
                            <div class="album-thumb">
                                <img src="<?php echo e(asset('storage/'.$img)); ?>" alt="" class="album-image">
                                <button type="button" class="delete-image js-remove-album-image">
                                    <i class=" icon-bin2"></i>
                                </button>
                                <input type="hidden" name="album[]" value="<?php echo e($img); ?>">
                            </div>
                        </div>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\laragon\www\tamviet-ecommerce\resources\views/backend/components/album.blade.php ENDPATH**/ ?>