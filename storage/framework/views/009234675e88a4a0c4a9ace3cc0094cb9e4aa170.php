                    ...
                    <div class="swiper-wrapper">
                        <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="swiper-slide mr-2 !w-[126px] md:mr-4 md:!w-[288px]">
                                <a href="<?php echo e(router_link('categories', $item->id)); ?>">
                        ...
                        <div class="swiper-slide mr-2 !w-[126px] md:mr-4 md:!w-[288px]">
                            <a href="http://phongkhamtaimuihongnhi.com/" target="_blank" rel="noopener noreferrer">
                                <div class="h-full w-full">
                                    <img
                                        class="h-full w-full rounded-sm object-contain"
                                        src="<?php echo e(asset('frontend/assets/image/brand/brand-1.png')); ?>"
...
<?php /**PATH C:\laragon\www\tamviet-ecommerce\resources\views/frontend/components/featured-brands.blade.php ENDPATH**/ ?>