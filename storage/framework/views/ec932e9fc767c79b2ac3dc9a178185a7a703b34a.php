<?php $__env->startSection('content'); ?>
    <?php echo $__env->make('frontend.product.partials.product-mobile-header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <div id="mainContent" class="z-20 mx-auto bg-white pt-14 md:pt-4">
        <div class="md:pb-0 pb-[87px]">
            <div>
                <?php echo $__env->make('frontend.components.breadcrumb', ['items' => $breadcrumb ?? []], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                ...
                <div
                    ...
                    <div class="grid md:gap-3">
                        <div class="grid grid-cols-1 items-start md:gap-6 lg:grid-cols-2 xl:grid-cols-2">
                            <div class="md:sticky md:top-0">
                                <?php echo $__env->make('frontend.product.partials.album', ['product' => $product], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            </div>
                            <div>
                                <div class="flex flex-col">
                                    ...
                                    <div class="flex flex-col px-4 md:px-0">
                                        <div class="grid grid-cols-[1fr,calc(24rem/16)] gap-4 md:grid-cols-1 mb-2">
                                            <h1 title="<?php echo e($product->name ?? ''); ?>"
                                        ...
                                        <div class="flex items-center justify-between mb-3 md:mb-4">
                                            <div class="flex content-start items-center space-x-1 py-[calc(2rem/16)]">
                                                <p class="text-sm leading-5 text-neutral-600"><?php echo e($product->sku ?? ''); ?></p>
                                                <span class="h-1 w-1 rounded-full bg-neutral-600"></span>
                                                <?php if($product->brand): ?>
                                                    <a class="text-sm leading-5 text-primary-500"
                                                       href="<?php echo e(router_link('brands', $product->brand->id)); ?>">
                                                        Thương hiệu: <?php echo e($product->brand->name); ?>
                    ...
                    <?php echo $__env->make('frontend.product.partials.cta-desktop',['product' => $product], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    <?php echo $__env->make('frontend.product.partials.cta-mobile', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    <?php echo $__env->make('frontend.product.partials.add-to-cart-modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
            </div>
            <div class="bg-neutral-100 h-3"></div>
            <?php echo $__env->make('frontend.product.partials.related-brand', ['relatedProducts' => $relatedProducts], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
    </div>
<?php $__env->stopSection(); ?>
<?php $__env->startPush('scripts'); ?>
    <script src="<?php echo e(asset('frontend/assets/js/product.js')); ?>"></script>
    <script src="<?php echo e(asset('frontend/assets/js/modal-add-to-cart.js')); ?>"></script>
<?php $__env->stopPush(); ?>



<?php echo $__env->make('frontend.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\tamviet-ecommerce\resources\views/frontend/product/show.blade.php ENDPATH**/ ?>