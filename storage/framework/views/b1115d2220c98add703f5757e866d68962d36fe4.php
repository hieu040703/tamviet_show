...
<div class="flex flex-col">
    <?php if($widget && $categories->isNotEmpty() && $firstPost): ?>
            ...
            <div>
                <div class="block-title flex items-center p-4 md:px-0">
                    <h4
                        ...
                        <?php echo e($widget->name ?? 'Góc sức khỏe'); ?>
                    ...
                    <div>
                        <a
                            ...
                            type="button" href="<?php echo e(router_link('post_catalogue', $firstCat->id)); ?>">Xem tất cả</a>
                    </div>
                </div>
            </div>
            <div class="mb-4">
                    ...
                    <div class="relative flex h-full w-full items-center">
                        <div
                            ...
                            <div class="swiper-wrapper">
                                ...
                                <?php $__currentLoopData = $categories->skip(1); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="swiper-slide mr-4 !w-auto last:mr-2">
                                        <a
                                            ...
                                            href="<?php echo e(router_link('post_catalogue', $cat->id)); ?>"
                                        >
                ...
                <div class="first:row-span-3 first:mb-3 md:block">
                    <div class="group-data-[cate=&quot;false&quot;]:-mb-4  md:-mb-10">
                        <div class="aspect-blog-image overflow-hidden rounded-sm mb-2 h-[248px] w-full">
                            <a href="<?php echo e(router_link('posts', $firstPost->id)); ?>">
                                <img
                                    class="h-full w-full object-cover"
                                    src="<?php echo e($firstPost->image ? asset('storage/'.$firstPost->image) : asset('backend/img/not-found.jpg')); ?>"
                                    alt="<?php echo e($firstPost->name); ?>" loading="lazy"
                        ...
                        <div class="flex flex-1 flex-col">
                            <div class="mb-2 flex items-start">
                                <a
                                    ...
                                    href="<?php echo e(router_link('post_catalogue', $firstCat->id)); ?>">
                                    <div class="[&_a:not(.ignore-css_a)]:text-hyperLink">
                                        <?php echo e($firstCat->name); ?>

                                    </div>
                                </a>
                            </div>
                            <a class="-mt-1 mb-1 line-clamp-2 font-semibold text-base"
                               href="<?php echo e(router_link('posts', $firstPost->id)); ?>">
                                <div class="[&amp;_a:not(.ignore-css_a)]:text-hyperLink">
                                    <?php echo e($firstPost->name); ?>
                            ...
                            <div
                                ...
                                <p>
                                    <?php echo $firstPost->description; ?>
                        ...
                        >
                            ...
                            <div class="flex flex-1 flex-col">
                                <div class="mb-2 flex items-start">
                                    <a
                                        class="line-clamp-1 rounded-sm bg-neutral-800 px-1 py-[2px] text-xs font-medium text-white"
                                        href="<?php echo e(router_link('post_catalogues', $firstCat->id)); ?>">
                                        <div class="[&_a:not(.ignore-css_a)]:text-hyperLink">
                                            <?php echo e($firstCat->name); ?>
