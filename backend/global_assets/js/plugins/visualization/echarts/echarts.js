...
!(function (e) {
        ...
        (i.prototype = {
          ...
          addData: function (e, t, i, n, r) {
            function s() {
              if (X._zr) {
                ...
                for (var e = 0, t = L.length; t > e; e++)
                  L[e].motionlessOnce =
                    h.addDataAnimation && L[e].addDataAnimation;
                X._messageCenter.dispatch(
                  a.EVENT.REFRESH,
                  null,
                  { option: h },
                  X
            ...
            for (
              ...
              if (p) {
                var U = p.data,
                  g = h.series[e].data;
                if (
                  (U[u](t), g[u](t), n || (U[V](), (t = g[V]())), null != r)
                ) {
                  var f, y;
                  if (
                    p.type === a.CHART_TYPE_PIE &&
                    (f = d.legend) &&
                    (y = f.data)
                  ) {
                    var b = h.legend.data;
            ...
            for (
              ...
              h.addDataAnimation &&
                L[c].addDataAnimation &&
                (w++, L[c].addDataAnimation(l, W));
  ...
  define(
    ...
    function (e) {
        ...
        u = {
          ...
          click: function (e) {
            ...
            ((t && t.clickable) || !t) &&
              ...
              this._dispatchAgency(t, c.CLICK, e),
          ...
          dblclick: function (e) {
            ...
            ((t && t.clickable) || !t) &&
              this._clickThreshold < 5 &&
              this._dispatchAgency(t, c.DBLCLICK, e),
              this._mousemoveHandler(e);
          },
          ...
          mousemove: function (e) {
            if (!this.painter.isLoading()) {
              ...
              if (this._draggingTarget)
                this.storage.drift(this._draggingTarget.id, t, i),
          ...
          touchend: function (e) {
            ...
            var t = new Date();
            t - this._lastTouchMoment < c.touchClickDelay &&
              (this._mobileFindFixed(e),
              this._clickHandler(e),
              t - this._lastClickMoment < c.touchClickDelay / 2 &&
      ...
      return (
        (V.prototype._mobileFindFixed = function (e) {
          (this._lastHover = null),
        ...
        l.merge(V.prototype, m.prototype, !0),
        V
      );
    }
  ),
        ...
        (i.prototype = {
          ...
          animationEffect: function (e) {
            if (
              ...
              this.canvasSupported &&
                this.zr.modLayer(t, { motionBlur: !0, lastFrameAlpha: 0.95 });
