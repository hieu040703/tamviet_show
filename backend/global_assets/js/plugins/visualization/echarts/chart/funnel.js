    ...
    (t.prototype = {
          ...
          if (e[n].type === r.CHART_TYPE_FUNNEL) {
            if (
              ...
              (this.legendHoverLink =
                e[n].legendHoverLink || this.legendHoverLink),
              (i = e[n].name || ""),
              (this.selectedMap[i] = t ? t.isSelected(i) : !0),
              !this.selectedMap[i])
            )
              continue;
      ...
      _buildSingleFunnel: function (e) {
        ...
        for (var o, r = 0, s = [], h = 0, m = n.length; m > h; h++)
          (o = n[h].name),
            ...
            this.selectedMap[o] && !isNaN(n[h].value) && (s.push(n[h]), r++);
        if (0 !== r) {
          for (
            var V,
              U,
            ...
            if (((o = s[h].name), this.selectedMap[o] && !isNaN(s[h].value))) {
              switch (
                ((V =
                  m - 2 >= h
                    ...
                    : "descending" === i.sort
                    ? l.parsePercent(i.minSize, a.width)
                    : l.parsePercent(i.maxSize, a.width)),
                u)
              ) {
                case "left":
                  U = a.x;
              ...
              (d = this._buildItem(
                ...
                (b += g + y),
                (p = d.style.pointList),
                _.unshift([p[0][0] - 10, p[0][1]]),
                _.push([p[1][0] + 10, p[1][1]]),
                0 === h &&
                  (0 === f
                    ? ((p = _.pop()),
                      "center" == u && (_[0][0] += 10),
                      "right" == u && (_[0][0] = p[0]),
                      (_[0][1] -= "center" == u ? 10 : 15),
                      1 == m && (p = d.style.pointList))
                    : ((_[_.length - 1][1] -= 5), (_[0][1] -= 5))),
                (f = V);
            }
          c &&
            (_.unshift([p[3][0] - 10, p[3][1]]),
            _.push([p[2][0] + 10, p[2][1]]),
            0 === f
              ? ((p = _.pop()),
                "center" == u && (_[0][0] += 10),
                "right" == u && (_[0][0] = p[0]),
      ...
      _getLocation: function (e) {
        var t = this.series[e],
          ...
          r =
            null == t.width
              ? i - a - this.parsePercent(t.x2, i)
              : this.parsePercent(t.width, i);
        return {
          x: a,
          y: o,
          width: r,
          height:
            null == t.height
              ? n - o - this.parsePercent(t.y2, n)
              : this.parsePercent(t.height, n),
          centerX: a + r / 2,
        };
      },
      _mapData: function (e) {
        ...
        for (
          var n = this.series[e], a = h.clone(n.data), o = 0, r = a.length;
          r > o;
          o++
        )
          a[o]._index = o;
      ...
      _buildItem: function (e, t, i, n, a, o, r, l, h) {
        ...
        s.pack(d, m[e], e, m[e].data[t], t, m[e].data[t].name),
          this.shapeList.push(d);
        var p = this.getLabel(e, t, i, n, a, o, r, l, h);
        s.pack(p, m[e], e, m[e].data[t], t, m[e].data[t].name),
          this.shapeList.push(p),
          this._needLabel(V, U, !1) || (p.invisible = !0);
        var c = this.getLabelLine(e, t, i, n, a, o, r, l, h);
        this.shapeList.push(c),
          this._needLabelLine(V, U, !1) || (c.invisible = !0);
        var u = [],
          y = [];
        return (
          this._needLabelLine(V, U, !0) && (u.push(c.id), y.push(c.id)),
          this._needLabel(V, U, !0) && (u.push(p.id), y.push(d.id)),
          (d.hoverConnect = u),
          (p.hoverConnect = y),
          d
        );
      ...
      getPolygon: function (e, t, i, n, a, r, s, l, h) {
        var V,
          ...
          g =
            this.getItemStyleColor(u.color, e, t, d) ||
            ("string" == typeof y ? m.lift(y, -0.2) : y);
        switch (h) {
          case "left":
            V = n;
            break;
        ...
        return (
          this.deepQuery([d, U, this.option], "calculable") &&
      ...
      getLabel: function (e, t, i, a, o, r, s, l, U) {
        ...
        (b.position = b.position || y.normal.label.position),
          ...
          "center" === b.position
            ? ((d = U),
              (L =
                Math.max(r, s) / 2 > V.getTextWidth(x, _)
                  ? "#fff"
                  : m.reverse(i)))
