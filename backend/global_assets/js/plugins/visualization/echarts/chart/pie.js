  ...
  return (
    (t.prototype = {
      ...
      _buildShape: function () {
        ...
        for (var s, d = 0, c = e.length; c > d; d++)
          if (e[d].type === l.CHART_TYPE_PIE) {
            if (
              ((e[d] = this.reformOption(e[d])),
              (this.legendHoverLink =
                e[d].legendHoverLink || this.legendHoverLink),
              (s = e[d].name || ""),
        ...
        if (0 !== l) {
          for (
            ...
            if (((t = a[c].name), this.selectedMap[t] && !isNaN(a[c].value))) {
              if (
                ((u = o ? o.getColor(t) : this.zr.getColor(c)),
                (f = a[c].value / l),
                (p =
                  "area" != v
                    ? _
                ...
                (y = +V[1]),
                "radius" === v
                  ? (y = (a[c].value / h) * (y - U) * 0.8 + 0.2 * (y - U) + U)
                  : "area" === v &&
                    (y = Math.sqrt(a[c].value / h) * (y - U) + U),
                _)
              ) {
                var L;
                (L = b), (b = p), (p = L);
      ...
      _buildItem: function (e, t, i, n, a, o, r, s, l, d, c) {
        ...
        V &&
          (h.pack(V, m[t], t, m[t].data[i], i, m[t].data[i].name, n),
          e.push(V)),
          g &&
            (h.pack(g, m[t], t, m[t].data[i], i, m[t].data[i].name, n),
            (g._labelLine = V),
            e.push(g));
      },
      getSector: function (e, t, i, n, a, o, s, l, h, d) {
        var p = this.series,
          ...
          _ =
            this.getItemStyleColor(y.color, e, t, g) ||
            ("string" == typeof f ? m.lift(f, -0.2) : f),
          b = {
            zlevel: this.getZlevelBase(),
            z: this.getZBase(),
        ...
        return (
          ...
          this.deepQuery([g, u, this.option], "calculable") &&
      ...
      _layoutCalculate: function (e, t, i, n) {
        function a(t, i, n) {
          for (var a = t; i > a; a++)
            if (
              ...
              (e[a].style.y += n),
              e[a]._labelLine &&
                ((e[a]._labelLine.style.pointList[1][1] += n),
        ...
        function o(t, i) {
          for (
            ...
            (e[n].style.y -= i),
            e[n]._labelLine &&
              ((e[n]._labelLine.style.pointList[1][1] -= i),
            ...
            (r = Math.abs(e[c]._rect.y - h)),
              ...
              (o =
                n + s > r
                  ? Math.sqrt(
                      (n + s + 20) * (n + s + 20) -
                        Math.pow(e[c]._rect.y - h, 2)
                    )
                  : Math.abs(
                      e[c]._rect.x + (a > 0 ? 0 : e[c]._rect.width) - l
                    )),
              t && o >= d && (o = d - 10),
              !t && d >= o && (o = d + 10),
              (e[c]._rect.x = e[c].style.x = l + o * a),
              e[c]._labelLine &&
                ((e[c]._labelLine.style.pointList[2][0] = l + (o - 5) * a),
      ...
      reformOption: function (e) {
        var t = d.merge;
        return (
          (e = t(t(e || {}, d.clone(this.ecTheme.pie || {})), d.clone(l.pie))),
      ...
      addDataAnimation: function (e, t) {
        ...
        for (var f, o = 0, r = m.length; r > o; o++)
          if (((p = m[o]._seriesIndex), a[p])) {
            if (
              ((U = m[o]._dataIndex + V[p]), (y = p + "_" + U), (f = h[y]), !f)
            )
              continue;
            if ("sector" === m[o].type)
              "delete" != f
          ...
          for (
            ...
            if (this.shapeList[s].id === n.id) {
              ...
              this.shapeList[s].style._hasSelected &&
                ...
                ((o = h.get(this.shapeList[s], "seriesIndex")),
