...
document.addEventListener('DOMContentLoaded', function() {
    ...
    $('.btn-delete-confirm').on('click', function (e) {
        ...
        const confirmText = this.getAttribute('confirmbuttontext') || 'Yes';
        const cancelText = this.getAttribute('cancelbuttontext') || 'Cancel';
    ...
    $("#reset-filter-form").on('click', function (event) {
        event.preventDefault();

        let form = $(this).closest('form');
        form.find('input[type="text"], input[type="number"], input[type="datetime-local"], input[type="date"]').val('');
    ...
    // Hiển thị và ẩn popover-content khi hover
...
//     // Kiểm tra xem sự kiện click có xuất hiện trong popover-container hay không
//     const isClickInsidePopover = popoverContainer.contains(event.target);

//     // Nếu click không xuất hiện trong popover-container, ẩn popover-content
